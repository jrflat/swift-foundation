...
extension URL {
    ...
    private static func parse<T: _URLEncoding, Impl: _URLParseable>(
        _ type: T.Type,
    ...
    static func parse<T: _URLEncoding, Impl: _URLParseable>(
        _ type: T.Type,
    ...
    private static func schemeFlags<T: UnsignedInteger & FixedWidthInteger>(
    ...
    private static func hasFileReferencePath<T: UnsignedInteger & FixedWidthInteger>(
        _ buffer: UnsafeBufferPointer<T>,
        pathStart: Int,
        pathLength: Int
    ) -> Bool {
    ...
    private static func shouldIgnorePort<T: UnsignedInteger & FixedWidthInteger>(
        _ buffer: UnsafeBufferPointer<T>,
        schemeLength: Int
    ) -> Bool {
    ...
    private static func encode<T: _URLEncoding, Impl: _URLParseable>(
        _ type: T.Type,
        span: borrowing Span<T.CodeUnit>,
        flags: inout _URLFlags,
