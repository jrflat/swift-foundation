...
private enum FileSystemType: Hashable {
    ...
    init(_ fsType: String) {
        ...
        case Array("iso9660".utf8): .iso9660
        case Array("jfs".utf8): .jfs
        case Array("minix".utf8): .minix
        case Array("ntfs".utf8): .ntfs
        case Array("reiser4".utf8): .reiser4
        case Array("reiserfs".utf8): .reiserfs
...
private let knownFileSystems: [FileSystemType: FileSystemSupportEntry] = [
    ...
    .iso9660: FileSystemSupportEntry(
        maximumFileSize: nil,
        compression: false,
        symbolicLinks: false,
        journaling: false,
        caseSensitiveNames: false,
        casePreservedNames: false,
        extendedSecurity: false,
        hardLinks: false,
        sparseFiles: false,
        fileCloning: nil,
    ...
    .minix: FileSystemSupportEntry(
        maximumFileSize: 2 * GiB,
        compression: false,
        symbolicLinks: true,
        journaling: false,
        caseSensitiveNames: true,
    ...
    .reiserfs: FileSystemSupportEntry(
        maximumFileSize: 8 * TiB,
        compression: false,
        symbolicLinks: true,
        journaling: true,
...
internal final class _URLResourceValuesProvider: _URLResourceValuesProviderProtocol {
    ...
    func fileContentIdentifier() throws -> Int64? {
        nil
    }
...
#endif // !canImport(Darwin) && !os(Windows) && canImport(Glibc)
#endif // !NO_FILESYSTEM
